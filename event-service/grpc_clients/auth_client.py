...
def verify_token(token: str):
    """
    Returns (valid: bool, user_id: str | None, error: str)
    """
    ...
    try:
        ...
        return response.valid, response.user_id, response.error
    except grpc.RpcError as e:
        return False, None, f"Auth service unreachable: {e.details()}"